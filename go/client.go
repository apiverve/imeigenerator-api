...
const (
	baseURL        = "https://api.apiverve.com/v1/imeigenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the IMEI Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new IMEI Generator API client.
...
// Execute makes a request to the IMEI Generator API with typed parameters.
//
