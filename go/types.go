// Package imeigenerator provides a Go client for the IMEI Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/imeigenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the IMEI Generator API.
//
// Parameters:
//   - brand: string - Filter by manufacturer brand (e.g., Samsung, Apple, Nokia)
//   - count: integer - Number of IMEIs to generate [min: 1, max: 5]
type Request struct {
...
// ResponseData contains the data returned by the IMEI Generator API.
type ResponseData struct {
	Count int `json:"count"`
	Brand string `json:"brand"`
	Imeis []ImeisItem `json:"imeis"`
}

// ImeisItem represents an item in the Imeis array.
type ImeisItem struct {
