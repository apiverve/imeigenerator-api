...
class imeigeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/imeigenerator');
        }
        ...
        this.validationRules = {"brand":{"type":"string","required":false},"count":{"type":"integer","required":false,"min":1,"max":5,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/imeigenerator`);
        }
    }
...
module.exports = imeigeneratorWrapper;
