...
```gradle
dependencies {
    implementation 'com.github.apiverve:imeigenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.imeigenerator.IMEIGeneratorAPIClient;
import com.apiverve.imeigenerator.APIResponse;
import com.apiverve.imeigenerator.APIException;

// Initialize the client
IMEIGeneratorAPIClient client = new IMEIGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("brand", "Samsung");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/imeigenerator](https://docs.apiverve.com/ref/imeigenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/imeigenerator](https://docs.apiverve.com/ref/imeigenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/imeigenerator-api/issues)
