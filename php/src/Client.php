...
namespace APIVerve\Imeigenerator;
...
/**
 * Client for the IMEI Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/imeigenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/imeigenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ImeigeneratorClient] {$message}\n";
        }
    }
}
